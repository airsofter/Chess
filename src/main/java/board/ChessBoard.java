...
public class ChessBoard {
    ...
    private int getPlayerNumber() {
        return nowPlayer.equals("White") ? 1 : 2;
    }

    public void printBoard() {
        System.out.println("Turn: Player " + getPlayerNumber() + " (" + nowPlayer + ")");
        System.out.println();
        ...
        System.out.println("It's Player " + getPlayerNumber() + "'s (" + nowPlayer + ") turn. Enter your move:");
    }
